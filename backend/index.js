...
app.get('/api/get_absences/:camp_id', (req, res) => {
    ...
    let query = 'SELECT * FROM absent WHERE camp_id = $1'
    let values = [camp_id]
...
app.post('/api/new_absence/:camp_id', (req, res) => {
    ...
    // Add to database
    let addQuery = 'INSERT INTO absent (camp_id, camper_name, date, followed_up, reason, date_modified,upd_by) VALUES ($1, $2, $3, $4, $5, $6, $7)'
    let addQueryValues = [camp_id, req.body.name, req.body.date, req.body.followedUp, req.body.notes, (new Date()).toISOString(), 0]
